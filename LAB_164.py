##Sekcja 10, wykład 163
##Teraz zajmiemy się rozwiązaniem równania kwadratowego.
##Te kilka wzorów może się przydać:
##Przyda się również funkcja, która sprawdzi czy liczba jest całkowita
##(funkcja isdecimal() niespecjalnie mi się podoba,
## bo jej zdaniem liczby ujemne np. -1 nie jest liczbą całkowitą):
##    def check_int(s):
##        if s[0] in ('-', '+'):
##            return s[1:].isdigit()
##        return s.isdigit()
...
##        jeżeli tak, należy wyświetlić informację,
##        że to nie jest równanie kwadratowe i zakończyć skrypt
##        w przeciwnym razie
##            należy wyliczyć deltę
##            jeżeli delta <0, to należy wyświetlić komunikat
##            o braku rozwiązań i zakończyć skrypt
##            jeżeli delta=0,  to należy wyliczyć x1,
##            wyświetlić wynik i zakończyć skrypt
##            jeżeli delta>0, to należy wyliczyć x1 i x2 ,
##            wyświetlić wynik i zakończyć skrypt 
