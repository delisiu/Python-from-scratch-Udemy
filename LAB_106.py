...
##2+3 = 5
##....
##Korzystając z pętli for napisz program,
##który wyliczy fibonacciIterations=20 pierwszych elementów ciągu Fibonacciego
##Wskazówka:
##-zadeklaruj 3 dodatkowe zmienne a1, a2 i a3.
##Początkowo a1=0 a a2=1.
##a3 będziesz wyliczać jako sumę a1 i a2.
...
##Wskazówki:
##-zadeklaruj zmienną wordDictionary typu dictionary.
##Obiekt na początku ma być pusty
##więc do jego zainicjowania możesz skorzystać z {}.
##W tym dictionary kluczem będzie słowo z tekstu
##a wartością ilość wystąpień słowa w tekście
##-korzystając z funkcji split(' ') podziel napis
##na słowa i zaopamietaj w tablicy listOfWords
##-dla każdego słowa z tej listy (pętla FOR)
##-jeżeli słowo już jest na liście wordictionary.keys()
##- to do value dodaj 1 
##-jeżeli słowo nie występowało jeszcze na liście
##to dodaj je jako nowy element dictionary
##z kluczem równym słowu i wartością 1 (można skorzystać np z funkcji  
##    setdefault 
##lub notacji 
