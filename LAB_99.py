...
##Ten tekst to definicja pewnego pojęcia.
##Twoim zadaniem jest zbudowanie streszczenia tej definicji
##poprzez wyświetlenie piewszych 20 słów
...
##        ]
##Twoim zadaniem jest zbudowanie streszczeń tych definicji
##poprzez wyświetlenie tylko pierwszych 20 słów z każdej definicji.
##Zmień w odpowiedni sposób rozwiązanie zadania 1,
##tak aby przetwarzana była cała lista
